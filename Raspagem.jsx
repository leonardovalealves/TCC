...
export default function Raspagem() {
  return (
    <div>
      <header>
           <img
      ...
      <h1>Raspagem de piso de madeira</h1>
      <br />
      <div className="ilum">
        <h3>
          A raspagem de piso de madeira é um serviço profissional voltado para
          quadras poliesportivas e áreas esportivas, que renova e prolonga a
          vida útil do piso. Utilizamos equipamentos modernos e lixas de
          precisão para eliminar desgastes e irregularidades, aplicando seladores
          e vernizes de alta performance que garantem aderência, brilho e
          resistência, resultando em um acabamento uniforme e seguro para a
          prática esportiva.
        </h3>
      </div>
      ...
      <div className="tudo">
        <div className="imagens1">
          <div className="imagem1">
            <img
              src="https://static.sportit.com.br/public/sportit/imagens/produtos/pisos-de-madeira-para-quadra-2791.jpeg"
              alt=""
              height="200px"
            />
          </div>
          <div className="imagem2">
            <img
              src="https://www.recoma.com.br/wp-content/uploads/2019/09/recoma-flex-premium.png"
              alt=""
              height="200px"
            />
          </div>
          <div className="imagem3">
            <img
              src="https://www.ramosquadras.com.br/images/RASPAGEM01.jpg"
              alt=""
              height="200px"
            />
          </div>
        ...
        <div className="imagens2">
          <div className="imagem4">
            <img
              src="https://www.ramosquadras.com.br/images/RASPAGEM03.jpg"
              alt=""
              height="200px"
            />
          </div>
          <div className="imagem5">
            <img
              src="https://www.ramosquadras.com.br/images/RASPAGEM07.jpg"
              alt=""
              height="200px"
            />
          </div>
          <div className="imagem6">
            <img
              src="https://ecrie.com.br/sistema/conteudos/imagem/m_70_0_1_21072022163549.jpeg"
              alt=""
              height="200px"
            />
          </div>
