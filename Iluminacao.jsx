  ...
  return (
      ...
      <Link to="/outrosEsportes"><button>Esportes pouco conhecidos</button></Link>
        ...
        <Link to="/ajude"><button>Ajude-nos</button></Link>
               ...
               <h1>Iluminação</h1>
        <div className='ilum'>
       <h3>Oferecemos sistemas completos de iluminação profissional para quadras poliesportivas, <br /> com tecnologia LED avançada que garante alta performance, economia de energia, <br /> durabilidade e resistência às condições climáticas. <br /> A instalação é personalizada conforme o tamanho e uso da quadra, assegurando potência, <br /> uniformidade e conforto visual para uma experiência esportiva de qualidade.</h3>
        </div>
        <div className='tudo'>
         <div className='imagens1'>
        <div className='imagem1'>
      <img src="https://www.ramosquadras.com.br/images/iluminacao.jpg" alt="" height={'300px'}/>
        </div>
        <div className='imagem2'>
      <img src="https://www.ramosquadras.com.br/images/ILUMINACAO2.jpg" alt="" height={'300px'}/>
        </div>
        <div className='imagem3'>
       <img src="https://www.ramosquadras.com.br/images/ILUMINACAO3.jpg" alt="" height={'300px'}/>
        </div>
        </div>
        
        <div className='imagens2'>
        <div className='imagem4'>
        <img src="https://www.ramosquadras.com.br/images/ILUMINACAO1.jpg" alt="" height={'300px'}/>
        </div>
        <div className='imagem5'>
     <img src="https://media.discordapp.net/attachments/1399878782134780027/1428480184079745045/refletor4_1.png?ex=68f69bd7&is=68f54a57&hm=1058a450c3dec2c2dc2e0717861ea594db5e6a3e87153eaa30946a4591d26bf6&=&format=webp&quality=lossless&width=383&height=548" alt="" height={'300px'}/>
        </div>
        <div className='imagem6'>
     <img src="https://tse1.mm.bing.net/th/id/OIP.YiiHUVkSjM6DpF_8XN0twAHaE8?rs=1&pid=ImgDetMain&o=7&rm=3" alt="" height={'260px'} />
        </div>
        </div>
        </div>
